---
title: "Master CBSE Question Bank: All Questions from Last 5 Years (2020-2025) with Marking Schemes"
...
1. Describe the construction of the apparatus and the experimental setup used by Lenard and Millikan to study the photoelectric effect. Explain the role of:
   ...
   *(2 Marks)*
2. Light of wavelength $2000\text{ \AA}$ falls on an aluminium surface with work function $4.2\text{ eV}$. Calculate:
...
$$
\lambda = 2000\text{ \AA} = 2000 \times 10^{-10}\text{ m} = 2 \times 10^{-7}\text{ m}
$$
...
$$
\phi_0 = \frac{hc}{\lambda_0} \implies \lambda_0 = \frac{hc}{\phi_0} = \frac{6.63 \times 10^{-34} \times 3 \times 10^8}{4.2 \times 1.6 \times 10^{-19}} = \frac{1.989 \times 10^{-25}}{6.72 \times 10^{-19}} \approx 2.96 \times 10^{-7}\text{ m} = 2960\text{ \AA}
$$
